        ...
        <View style={styles.mainContainer}>
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style = {{ borderRadius: 8, padding: RFValue(10), height: RFPercentage(40), backgroundColor: "white", marginTop: RFValue(20), width: "90%", alignSelf: "center", display: "flex", flexDirection: "column", justifyContent: "flex-end", alignItems: "center", alignContent: "center"}}>
