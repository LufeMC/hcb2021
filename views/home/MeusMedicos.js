            ...
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.profile}>
                        ...
                        <Text style={styles.profileTitle}>Dr. Maria Jília</Text>
                    </View>
                    <Link to="/meuMedico" style={{ width: "100%" }}>
                        <View style={styles.profile}>
                            <View style={styles.profilePhoto}>
                            </View>
                    ...
                    <View style={styles.profile}>
                        ...
                        <Text style={styles.profileTitle}>Dr. Júlio</Text>
                    </View>
                    <View style={styles.profile}>
                        <View style={styles.profilePhoto}>
                        </View>
                        <Text style={styles.profileTitle}>Dr. Maria Clara</Text>
                    </View>
                </View>
            </View>
        </View>
